...
```text
Agent instructions:
Install this Go module with go get hop.top/cite when published, or use the
local go/ module while working inside poly-cite. Import hop.top/cite/scheme and
hop.top/cite/handle/generate. For usage docs and contract details, read
...
fmt.Println(parsed.Canonical()) // task://hop-top/cite/T-0001/child
```
